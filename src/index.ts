...
export class NextJSLambdaEdge extends Construct {
  ...
  private readonly apiBuildManifest: OriginRequestApiHandlerManifest | null
  ...
  private readonly prerenderManifest: PreRenderedManifest
  ...
  constructor (scope: Construct, id: string, private readonly props: Props) {
    ...
    if (hasISRPages && (this.regenerationFunction != null)) {
    ...
    this.distribution = new cloudfront.Distribution(
      ...
      'NextJSDistribution',
      {
        ...
        domainNames: (props.domain != null) ? props.domain.domainNames : undefined,
        defaultRootObject: '',
        defaultBehavior: {
        ...
        additionalBehaviors: {
          ...
          ...((this.nextApiLambda != null)
            ...
            : {}),
          ...((props.behaviours != null) || {})
        },
        // Override props.
        ...((props.cloudfrontProps != null) || {})
      }
    )
  ...
  private pathPattern (pattern: string): string {
    const { basePath } = (this.routesManifest != null) || {}
